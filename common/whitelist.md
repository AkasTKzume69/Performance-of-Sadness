...
The `whitelist.prop` file is automatically created in the root of your SD card on the first boot of the module.
...
You can edit this file using any text editor app on your Android device that can access the SD card. Some popular options include:
...
You can also use a PC by connecting your device via USB and enabling file transfer.
