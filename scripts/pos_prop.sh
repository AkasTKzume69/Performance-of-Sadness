...
echo "# Legends:" >> "$POS_PROP"
echo "# 🔴 = A reboot is required to apply changes" >> "$POS_PROP"
echo "# 🟢 = Applies in real time" >> "$POS_PROP"
echo "# ====================================" >> "$POS_PROP"
...
echo "# Available Governor:" >> "$POS_PROP"
echo "# schedutil, performance" >> "$POS_PROP"
...
echo "# Restore timeout when no game is detected" >> "$POS_PROP"
echo "pos_ai_restore_timeout=20" >> "$POS_PROP"
echo "### List of games that should use renderer" >> "$POS_PROP"
